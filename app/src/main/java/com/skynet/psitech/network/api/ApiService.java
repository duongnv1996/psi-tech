...
import com.skynet.psitech.models.HomeResponse;
...
import com.skynet.psitech.models.PlaceNearby;
...
public interface ApiService {
    ...
    @GET("notification_booking.php")
    Call<ApiResponse<List<Booking>>> getListNotification(@Query("tech_id") String uid, @Query("type") int type);

    @GET("notification.php")
    Call<ApiResponse<List<Notification>>> getNotification(@Query("id") String uid, @Query("type") int type);

    @GET("list_report.php")
    Call<ApiResponse<List<Feedback>>> getListFeedback(@Query("tech_id") String uid);
    ...
    Call<ApiResponse> toggleOnline(@Field("tech_id") String idUser, @Field("online") int isFav);
    ...
    @GET("statistic.php")
    Call<ApiResponse<Report>> getReport(@Query("tech_id") String idUser, @Query("type") int type);
    ...
    @FormUrlEncoded
    @POST("status_booking.php")
    Call<ApiResponse> updateStatusBooking(@Field("id") int idHis, @Field("active") int active);
    ...
    @Multipart
    @POST("report_device.php")
    Call<ApiResponse> addFeeback(@Part("tech_id") RequestBody tech_id, @Part("booking_id") RequestBody booking_id, @Part("content") RequestBody content,
                                 @Part("address") RequestBody address,  @Part("time_report") RequestBody time_report, @Part List<MultipartBody.Part> listFile);

    @Multipart
    @POST("update_image_booking.php")
    Call<ApiResponse> addPhotoBooking(@Part("booking_id") RequestBody booking_id, @Part("type") RequestBody type,  @Part List<MultipartBody.Part> listFile);
