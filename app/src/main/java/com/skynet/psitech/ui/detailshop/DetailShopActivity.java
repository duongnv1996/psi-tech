...
import com.skynet.psitech.ui.cart.CartActivity;
import com.skynet.psitech.ui.search.ActivitySearch;
...
//        tabLayout.setupWithViewPager(viewpager);
    ...
    public void onViewShareClicked() {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, "http://psitech.vn/shop_detail.php?id="+shopDetail.getShop().getId());
