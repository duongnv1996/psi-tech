...
//    SwipeRefreshLayout swipe;
    ...
    List<Booking> listGroupServices = new ArrayList<>();
...
//        dialogLoading.hideDialog();
    ...
    @Override
    public void onSuccessGetServices(List<Booking> listGroupServices) {
    ...
    public void onCallBack(int pos) {
        Intent i = new Intent(NotificationActivity.this, ActivityBookingDetail.class);
...
//        }
        i.putExtra(AppConstant.MSG, this.listGroupServices.get(pos).getBooking_id());
