...
public interface ListProductContract {
    interface View extends BaseView {
        void onSucessGetListProduct(Report res, int index);        void onSucessGetCart(Cart cart);
    ...
    interface Listener extends OnFinishListener {
        void onSucessGetListProduct(Report response);        void onSucessGetCart(Cart cart);
