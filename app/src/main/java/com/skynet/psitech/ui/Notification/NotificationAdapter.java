...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
    ...
    public NotificationAdapter(List<Booking> list, Context context, ICallback iCallback) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvTime.setText("Thực hiện vào " + list.get(position).getHour_working() + "-" + list.get(position).getDate_working());
        holder.tvAddress2.setText(list.get(position).getAddress());
        holder.textView60.setText(list.get(position).getService_name());
