...
import com.skynet.psitech.models.Technical;
import com.skynet.psitech.network.socket.SocketConstants;
import com.skynet.psitech.network.socket.SocketResponse;
import com.skynet.psitech.ui.base.BaseActivity;
import com.skynet.psitech.ui.detailhistory.HistoryDetailActivity;
import com.skynet.psitech.ui.views.ChatParentLayout;
...
//            }
//        }));
        if (user != null && shop != null  && user.getId() != null && shop.getId() != null)
