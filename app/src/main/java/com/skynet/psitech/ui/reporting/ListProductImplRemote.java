...
public class ListProductImplRemote extends Interactor implements ListProductContract.Interactor {
    ...
    public void getListProduct(int index) {
        ...
        getmService().getReport(profile.getId(), index).enqueue(new CallBackBase<ApiResponse<Report>>() {
            @Override
            public void onRequestSuccess(Call<ApiResponse<Report>> call, Response<ApiResponse<Report>> response) {
            ...
            @Override
            public void onRequestFailure(Call<ApiResponse<Report>> call, Throwable t) {
...
//            return;
//        }
//        getmService().ge(profile.getId()).enqueue(new CallBackBase<ApiResponse<Cart>>() {
//            @Override
